...
namespace BriefFiniteElementNet.CodeProjectExamples
{
    class Program
    {
        ...
        private static void Example1()
        {
             ...
             */
            // here I replace the trusselement with frameelement 
            ...
            Console.WriteLine("R1 : " + r1.ToString() + Environment.NewLine);
            Console.WriteLine("R2 : " + r2.ToString() + Environment.NewLine);
            Console.WriteLine("R3 : " + r3.ToString() + Environment.NewLine);
            Console.WriteLine("R4 : " + r4.ToString() + Environment.NewLine);
            Console.WriteLine("Total : " + rt.ToString() + Environment.NewLine);
            /*
            var f1 = e1.GetInternalForceAt(.5*e1.GetElementLength());
            var f2 = e2.GetInternalForceAt(.5 * e1.GetElementLength());
            var f3 = e3.GetInternalForceAt(.5 * e1.GetElementLength());
            var f4 = e4.GetInternalForceAt(.5 * e1.GetElementLength());
             * */
            var f1 = e1.GetInternalForceAt(0);
            var f2 = e2.GetInternalForceAt(0);
            var f3 = e3.GetInternalForceAt(0);
            var f4 = e4.GetInternalForceAt(0);
            Console.WriteLine("internal force of element 1 : " + f1.ToString() + Environment.NewLine);
            Console.WriteLine("internal force of element 2 : " + f2.ToString() + Environment.NewLine);
            Console.WriteLine("internal force of element 3 : " + f3.ToString() + Environment.NewLine);
            Console.WriteLine("internal force of element 4 : " + f4.ToString() + Environment.NewLine);
            Console.ReadKey();
        }
        ...
        private static void Example2()
        {
            ...
            model.Solve();
            //wnd.ShowDialog();
            var f1 = e2.GetInternalForceAt(0);
            var f2 = e2.GetInternalForceAt(.25 * e2.GetElementLength());
            var f3 = e2.GetInternalForceAt(.5 * e2.GetElementLength());
            var f4 = e2.GetInternalForceAt(.75 * e2.GetElementLength());
            var f5 = e2.GetInternalForceAt(1 * e2.GetElementLength());
            Console.WriteLine("internal force of element 1 : " + f1.ToString() + Environment.NewLine);
            Console.WriteLine("internal force of element 2 : " + f2.ToString() + Environment.NewLine);
            Console.WriteLine("internal force of element 3 : " + f3.ToString() + Environment.NewLine);
            Console.WriteLine("internal force of element 4 : " + f4.ToString() + Environment.NewLine);
            Console.WriteLine("internal force of element 5 : " + f4.ToString() + Environment.NewLine);
            Console.ReadKey();
        }
